export const PUBLIC_INVEST_ITEMS = {
	additional: [
		...
		"Purchased nft tickets will be sent to the investor's wallet within 48 hours.",
		"Tickets will be minted and sent to the addresses of the wallets from which the payment/purchase was made.",
		"The investor is not charged for the minting cost on Casper Network",
		"It is possible to burn tickets to get a $MYSTRA tokens (after TGE + vesting) or sell tickets on NFT marketplace (any time after tickets received - no vesting). We guarantee that after the Public Sale Round 5 is over, users will be publicly informed that platform tickets can be purchased on the secondary market. ",
	...
	about: [
		"$MYSTRA tokens can only be minted and claimed by burning Mystra Tickets. The more tickets you purchase, the more $MYSTRA tokens you can mint in the seed, private, and public rounds. The allocation of $MYSTRA tokens is equal for each round of ticket sales",

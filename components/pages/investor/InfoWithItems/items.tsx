export const PUBLIC_INVEST_ITEMS = {
	...
	about: [
		"$MYSTRA tokens can only be minted and claimed by burning Mystra Tickets. The more tickets you mint, the more $MYSTRA tokens you can mint in the seed, private, and public rounds. The allocation of $MYSTRA tokens is equal for each round of ticket sales",
